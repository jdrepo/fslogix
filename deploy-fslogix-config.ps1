...
try {
    if ($profileLocation) {
        ...
        New-ItemProperty -Path $fslogixPath -Name FlipFlopProfileDirectoryName -Value 1 -Property DWORD -Force | Out-Null
        New-ItemProperty -Path $fslogixPath -Name IsDynamic -Value 1 -Property DWORD -Force | Out-Null
        New-ItemProperty -Path $fslogixPath -Name ProfileType -Value 3 -Property DWORD -Force | Out-Null
